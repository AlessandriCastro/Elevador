...
public class Andar extends EntidadeSimulavel implements Serializable {
    ...
    public void removerPessoa(int id) {
        ...
        // Sempre remove o id da fila de prioridade
        boolean idRemovidoFila = pessoasAguardando.removerPorId(id);
        if (idRemovidoFila) {
            System.out.printf("DEBUG: ID %d removido da fila de prioridade do andar %d\n", id, numero);
        }
